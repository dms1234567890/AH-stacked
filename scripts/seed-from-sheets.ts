...
async function getSheetData(sheets: any, spreadsheetId: string, range: string) {
  try {
    ...
    console.warn(`Warning: Could not read sheet ${spreadsheetId}/${range}:`, (error as any)?.message);
    return [];
  }
}

async function seedUsers(sheets: any) {
  console.log('\n--- Seeding Users ---');
...
async function seedEmployees(sheets: any) {
  console.log('\n--- Seeding Employees ---');
...
async function seedTeachers(sheets: any) {
  console.log('\n--- Seeding Teachers ---');
...
async function seedSubjects(sheets: any) {
  console.log('\n--- Seeding Subjects ---');
...
async function seedBatches(sheets: any) {
  console.log('\n--- Seeding Batches ---');
...
async function seedAdmissions(sheets: any) {
  console.log('\n--- Seeding Admissions ---');
