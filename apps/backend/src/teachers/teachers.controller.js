...
let TeachersController = (() => {
    let _classDecorators = [ApiTags('Teachers'), ApiBearerAuth(), UseGuards(JwtAuthGuard, RolesGuard), Controller('teachers')];
    ...
    var TeachersController = class {
        ...
        static {
            ...
            _findAll_decorators = [Get(), ApiOperation({ summary: 'Get all teachers' })];
            _create_decorators = [Post(), ApiOperation({ summary: 'Create a teacher' })];
